...
const ALL_CONTENT: RecentItem[] = [
  ...
  },
  {
    ...
    content:
      "Comentarios repetitivos detectados, podrían ser spam.",
    sentiment: "negative",
    status: "flagged",
  ...
  },
  {
    ...
    content:
      "El servicio podría ser más rápido, pero no está mal.",
    sentiment: "neutral",
    status: "pending",
  ...
  },
  {
    ...
    content:
      "La plataforma funciona bien, aunque faltan detalles.",
    sentiment: "neutral",
    status: "pending",
  ...
  },
  {
    ...
    content:
      "El contenido es válido, pero requiere revisión adicional.",
    sentiment: "neutral",
    status: "pending",
...
/* ============================================================
   ...
   (aquí luego puedes llamar a OpenAI en vez de usar esta lista)
   ============================================================ */
...
export default function Home() {
  ...
  const loadMore = useCallback(async () => {
    ...
    setLoading(true);
    const { items: newItems, hasMore: more } =
      await mockFetchReviews(page, PAGE_SIZE);
  ...
  const handleGenerateAI = () => {
    ...
    // Aquí podrías llamar realmente a OpenAI:
    // const response = await fetch("/api/ai-review", { method: "POST", body: ... })
  };
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(ALL_CONTENT.length / PAGE_SIZE)
  );
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6">
          ...
          {activeTab === "moderation" && (
            <div className="text-center py-8 sm:py-12">
              ...
              <p className="text-gray-300 text-sm sm:text-base mb-6 px-4">
                Herramientas avanzadas de moderación y gestión de flujo
                de trabajo.
              </p>
          ...
          {activeTab === "analytics" && (
            <div className="text-center py-8 sm:py-12">
              ...
              <p className="text-gray-300 text-sm sm:text-base mb-6 px-4">
                Información completa y métricas de rendimiento para tu
        ...
        <div className="mt-6 sm:mt-8 text-center px-4">
          <p className="text-gray-400 text-[11px] sm:text-xs">
            Content Guardian v1.0.0 · Plataforma de moderación de
            contenido con IA · Desarrollado con Next.js 14 y TypeScript ·
            © 2024 Karl H. Camaro Porta
          </p>
        </div>
      </div>
    </main>
